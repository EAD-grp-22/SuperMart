...
public class DeliveryServiceImpl implements DeliveryService {
    ...
    public DeliveryResponse initiateDelivery(InitiateDeliveryRequest initiateDeliveryRequest){
        Delivery existingDelivery = deliveryRepository.findDeliveryByOrderNumber(initiateDeliveryRequest.getOrderNumber());
        if (existingDelivery != null) {
            throw new RuntimeException("Delivery for order number " + initiateDeliveryRequest.getOrderNumber() + " already exists");
        }
        ...
        Delivery delivery=Delivery.builder()
                ...
                .assignedTo(initiateDeliveryRequest.getAssignee())
    ...
    public String completeDelivery(String orderNumber) {
        ...
        if(delivery.getAssignedTo()==null){
            return "cannot complete delivery since it is not assigned to anyone";
        }
        ...
        CompleteOrderRequest completeOrderRequest =CompleteOrderRequest.builder()
                ...
                .build();
        callOrderAPIService.initiateCompleteOrder(completeOrderRequest);
